...
/**
 *  aprendoz_test.PersonalActivoId
 *  01/19/2015 07:58:53
 * 
 */
public class PersonalActivoId
    implements Serializable
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PersonalActivoId)) {
            return false;
        }
        PersonalActivoId other = ((PersonalActivoId) o);
        ...
        if (this.numeroTarjetaCredito == null) {
            if (other.numeroTarjetaCredito!= null) {
                return false;
            }
        } else {
            if (!this.numeroTarjetaCredito.equals(other.numeroTarjetaCredito)) {
                return false;
            }
        }
    ...
    public int hashCode() {
        ...
        rtn = (rtn* 37);
        if (this.numeroTarjetaCredito!= null) {
            rtn = (rtn + this.numeroTarjetaCredito.hashCode());
        }
        rtn = (rtn* 37);
        if (this.profesion!= null) {
